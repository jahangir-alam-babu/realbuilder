...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome back to RealBuilder</h1>
            <p class="col-lg-10 fs-4">
                RealStatueA real estate website is an online platform that allows individuals to buy, sell or rent properties, with tools such as property listings, search filters and property management solutions .
            </p>
        </div>
